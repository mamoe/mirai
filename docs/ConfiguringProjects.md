...
```kotlin
plugins {
    kotlin("jvm") version "1.4.31" // 请确保添加 Kotlin，至少使用 1.4.0 版本
}
...
dependencies {
    api("net.mamoe", "mirai-core", "2.4.2") // 替换为你需要的版本号
}
```
...
```groovy
plugins {
    id 'org.jetbrains.kotlin.jvm' version '1.4.31' // 请确保添加 Kotlin，至少使用 1.4.0 版本
}
...
```kotlin
dependencies {
    val miraiVersion = "2.4.2" // 替换为你需要的版本号
...
<dependencies>
    <dependency>
        ...
        <version>2.4.2</version> <!-- 替换版本为你需要的版本 -->
    </dependency>
</dependencies>
```
